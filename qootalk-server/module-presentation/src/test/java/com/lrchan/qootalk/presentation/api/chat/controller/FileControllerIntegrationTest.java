...
class FileControllerIntegrationTest extends ApiIntegrationTestSupport {
    ...
    class UploadFileTest {
        @Test
        @DisplayName("참여 사용자는 파일을 업로드할 수 있다")
    ...
    class GetFilesTest {
        @Test
        @DisplayName("파일을 업로드하고 목록을 조회할 수 있다")
        void getFilesSuccess() throws Exception {
            UserEntity uploader = createUser("list-uploader@qootalk.com", "Password123!", "목록업로더");
            UserEntity member = createUser("list-member@qootalk.com", "Password123!", "목록멤버");
